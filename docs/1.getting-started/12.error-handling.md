...
::note
For applications deployed to **static hosting** using `nuxt generate`, Nuxt pre-generates a `404.html` file in `.output/public/`. Your hosting provider will serve this file automatically for missing resources without needing a running server.
